...
console.log('🔄 Generating TypeScript types from FastAPI schema...');
...
`;
  ...
  if (error.message.includes('ECONNREFUSED') || error.message.includes('fetch')) {
    console.log('⚠️  API server not running. Creating fallback types...');
...
`;
    ...
    console.log('✅ Fallback types created. Run API server and regenerate for complete types.');
  } else {
    process.exit(1);
  }
}
