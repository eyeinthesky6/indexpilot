...
IndexPilot `1.1.0a5` is the current alpha release. Releases use PyPI Trusted Publishing rather
...
6. Verify in a clean environment:
   ...
   Replace `1.1.0a5` with the package version from the release being verified.
