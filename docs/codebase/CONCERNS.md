...
| Medium | Old public tag conflicts with preview maturity | Git tag `v1.0.0-stable`, `pyproject.toml` | Users may mistake historical code for the supported line | Point users to `v1.1.0a5`; keep the old tag explicitly historical |
