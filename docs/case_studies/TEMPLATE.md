...
**Size**: [Number of tables, rows, database size]  
...
### Context
- **Application**: [What application uses this database]
- **Workload**: [Type of workload - OLTP, OLAP, mixed]
- **Scale**: [Number of users, queries per second, etc.]
...
- **Created**: [Date]
- **Reason**: [Why IndexPilot created it]
- **Query Pattern**: [Query that triggered it]
...
|--------|--------|-------|-------------|-------|
| Average Query Time | X ms | Y ms | Z% | [Details] |
| P95 Query Time | X ms | Y ms | Z% | [Details] |
| P99 Query Time | X ms | Y ms | Z% | [Details] |
| Throughput | X qps | Y qps | Z% | [Details] |
| Slow Queries (>1s) | X/hour | Y/hour | Z% | [Details] |
