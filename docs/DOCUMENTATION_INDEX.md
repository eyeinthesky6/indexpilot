...
4. [Roadmap](ROADMAP.md) — evidence work planned after the preview
5. [Architecture](codebase/ARCHITECTURE.md) — current runtime owners and flow
6. [Known concerns](codebase/CONCERNS.md) — honest gaps and deferred production proof
