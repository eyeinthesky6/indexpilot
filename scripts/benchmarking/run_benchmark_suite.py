...
def main():
    ...
    parser.add_argument('--scenario', default='small', choices=['small', 'medium', 'large'],
    ...
    if all_passed:
        ...
        print(f"\nResults:")
        print(f"  - Baseline: docs/audit/toolreports/results_baseline.json")
        print(f"  - Autoindex: docs/audit/toolreports/results_with_auto_index.json")
        print(f"  - Case Study: docs/case_studies/CASE_STUDY_{args.scenario.capitalize()}_SCENARIO.md")
        return 0
    else:
